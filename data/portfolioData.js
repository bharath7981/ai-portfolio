...
export const initialPortfolioData = {
  personal: {
    ...
    title: "AI / ML ENGINEER & FULL STACK ARCHITECT",
    location: "INDIA • AVAILABLE WORLDWIDE",
    tagline: "Autonomous AI Agents • Production RAG • Open for Full-Time Roles",
    subtagline: "AI / ML Engineer specializing in multi-agent orchestration (LangGraph), high-throughput vector retrieval (RAG), production ML pipelines, and full-stack applications. Actively seeking full-time AI/ML engineering roles.",
    email: "rasalapubharath@gmail.com",
    github: "https://github.com/bharath7981",
    linkedin: "https://linkedin.com/in/bharath-rasalapu",
    specRole: "AI / ML Engineer",
    specFocus: "Open for Full-Time Roles & High-Impact Teams",
    specFrontend: "Next.js / React / TypeScript / Three.js",
    specBackend: "Python / FastAPI / LangGraph / PyTorch",
  },
  about: {
    bioHeader: "AI / ML ENGINEER // OPEN FOR FULL-TIME ROLES",
    bioLead: "I am an AI / ML Engineer and Full Stack Developer passionate about building production-grade autonomous agent systems, high-precision RAG pipelines, and high-concurrency microservices. Actively interviewing for full-time engineering roles.",
    bioPara1: "My work bridges machine learning research with robust software engineering — from architecting reflexive multi-agent decision graphs using LangGraph to engineering sub-10ms REST APIs with FastAPI and crafting responsive interfaces in Next.js.",
    bioPara2: "I help engineering teams build software that is intelligent by design — enabling systems to autonomously reason, retrieve grounded context, validate code, and execute complex workflows safely.",
  },
  projects: [
    {
      id: "01",
      ...
      github: "https://github.com/bharath7981/ai-portfolio",
      demo: "https://github.com/bharath7981/ai-portfolio",
      details: {
